...
class Candidato(models.Model):
    ...
    renda_bruta=models.CharField(verbose_name='O candidato possui renda bruta mensal igual ou inferior a 1,5 salários mínimos per capita?', choices=ESCOLHAS, max_length=1, default='N')
